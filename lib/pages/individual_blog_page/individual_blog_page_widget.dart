  ...
  Future<void> fetchBlogData() async {
    try {
      final querySnapshot = await FirebaseFirestore.instance
          ...
          .limit(1)
          .get();
      print("Fetch data : ${querySnapshot}");
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: wrapWithModel(
                                            model:
                                                _model.individualBlogCompModel1,
                                            updateCallback: () =>
                                                setState(() {}),
                                  ...
                                  children: [
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          30.0, 30.0, 30.0, 0.0),
                                      child: wrapWithModel(
                                        model: _model.individualBlogCompModel2,
                                        updateCallback: () => setState(() {}),
                                        child: IndividualBlogCompWidget(
                                          individualBlogImage:
                                              valueOrDefault<String>(
                                            _model
                                                .individualBlogDocumnet?.image,
                                            'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/virtuous-techlogic-website-mjpcg0/assets/ojp553es6376/virtuous-logo-only.png',
                                          ),
                                          individualBlogTitle:
                                              valueOrDefault<String>(
                                            _model
                                                .individualBlogDocumnet?.title,
                                            'BlogTitle',
                                          ),
                                          individualBlogDate:
                                              valueOrDefault<String>(
                                            _model.individualBlogDocumnet?.name,
                                            'BlogDate',
                                          ),
                                          individualBlogDescription:
                                              valueOrDefault<String>(
                                    ...
                                    Padding(
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        child: Builder(builder: (context) {
                                          if (_model.individualBlogResult?.title
                                                  .isEmpty ??
                                              true) {
                                            return CircularProgressIndicator();
                                          }
                                          return IndividualBlogCompWidget(
                                            individualBlogImage:
                                                valueOrDefault<String>(
                                              _model
