...
class PrivacyPolicytextcompWidget extends StatefulWidget {
  const PrivacyPolicytextcompWidget({super.key});

  @override
  State<PrivacyPolicytextcompWidget> createState() =>
      _PrivacyPolicytextcompWidgetState();
}

class _PrivacyPolicytextcompWidgetState
    extends State<PrivacyPolicytextcompWidget> {
  late PrivacyPolicytextcompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrivacyPolicytextcompModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                'Account means a unique account created for You to access our Service  parts of our Service.',
                                textAlign: TextAlign.start,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              'Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this  Agreement) refers to Virtuous Techlogic.',
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              'Device means any device that can access the Service such as a computer , acellphone or a digital tablet.',
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              'Website refers to Virtuous Techlogic, accessible from',
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          Flexible(
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'PRIVACY_POLICYTEXTText_lx5zuhwr_ON_TAP');
                                await launchURL(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'When You access the Service by or through a mobile device, We may collect certain information automatically, including, but not limited to, the type of mobile device You use, Your mobile device unique ID, the IP address of Your mobile device, Your mobile operating system, the type of mobile Internetbrowser You use, unique device identifiers and other diagnostic data.',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: FlutterFlowTheme.of(context)
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        'With Your consent : We may disclose Your personal information for an  other purpose with Your consent.',
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'PRIVACY_POLICYTEXTText_r5n3lbzc_ON_TAP');
                                                await launchURL(
                                                    'https://virtuoustechlogic.com/');
                                              },
                                              child: Text(
