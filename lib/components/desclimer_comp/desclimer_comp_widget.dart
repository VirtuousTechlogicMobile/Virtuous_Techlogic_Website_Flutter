...
import 'desclimer_comp_model.dart';
export 'desclimer_comp_model.dart';

class DesclimerCompWidget extends StatefulWidget {
  const DesclimerCompWidget({super.key});

  @override
  State<DesclimerCompWidget> createState() => _DesclimerCompWidgetState();
}

class _DesclimerCompWidgetState extends State<DesclimerCompWidget> {
  late DesclimerCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DesclimerCompModel());
                          ...
                          children: [
                            ...
                            Flexible(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'DESCLIMER_COMP_COMP_Text_wezzn0gc_ON_TAP');
                                  await launchURL(
                                  ...
                                  children: [
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'DESCLIMER_COMP_COMP_Text_2x89y51x_ON_TAP');
                                                  await launchURL(
                                                      'https://virtuoustechlogic.com/');
                                                },
                                                child: Text(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: Text(
                                            'By mail: 735, R K World Tower, 150 Feet Ring Rd, near Shital Park, Sheetal Park, Shastri Nagar, Chowk, Rajkot, Gujarat 360006',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily:
