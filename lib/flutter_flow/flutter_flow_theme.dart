...
abstract class FlutterFlowTheme {
  ...
  late Color info;
  late Color footer;
  late Color text16Color;
  late Color text16Colo2;
  late Color black;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0586E2);
  late Color secondary = const Color(0xFF003D69);
  late Color tertiary = const Color(0xFFF8AB27);
  ...
  late Color footer = Color(0xFF002743);
  late Color text16Color = Color(0xFF3D4163);
  late Color text16Colo2 = Color(0xFF676767);
  late Color black = Color(0xFF000000);
  late Color datecolor = Color(0xFFA6A6A6);
